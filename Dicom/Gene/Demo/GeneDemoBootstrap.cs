...
namespace Dicom.Gene
{
    ...
    public class GeneDemoBootstrap : MonoBehaviour
    {
        ...
        // 未画取区域(灰色幽灵底图)淡显不透明度(0=近全透,1=不透明);现走 alpha-to-coverage 抖动透明,
        // 有效显示密度约等于此值,MSAA=2 下低于 0.25 会几乎不可见,故起点取 0.35
        [SerializeField, Range(0f, 1f)] float _selectionFadeAlpha = 0.35f;
